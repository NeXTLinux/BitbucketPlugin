package com.cyanoth.bitbucketplugin.conditions;
...
public class PullRequestMergeCheckEnabled implements Condition {
    ...
    private static final String HOOK_KEY = "com.cyanoth.bitbucketplugin:has-secret-pr-merge-check";
    ...
    public boolean shouldDisplay(final Map<String, Object> context) {
        ...
        try {
            ...
            return this.securityService.withPermission(Permission.REPO_ADMIN, "BitbucketPlugin Retrieving Merge Check State")
            .call(
            ...
            log.error("Failed to get BitbucketPlugin Merge Check state. Assuming disabled.", e);
            return false;
        }
    }
}
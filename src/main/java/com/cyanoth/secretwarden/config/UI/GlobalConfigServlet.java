package com.cyanoth.bitbucketplugin.config.UI;
...
public class GlobalConfigServlet extends HttpServlet
{
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException
    {
        ...
        this.pageBuilderService.assembler().resources().requireContext("com.cyanoth.bitbucketplugin.globaladmin");

        soyTemplateRenderer.render(response.getWriter(), "com.cyanoth.bitbucketplugin:bitbucketplugin-globalconfig-ui-res",
                "com.cyanoth.bitbucketplugin.configPage", null);
    }
